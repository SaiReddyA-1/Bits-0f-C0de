  ...
  return (
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        I am a self-taught developer currently pursuing BTech in Computer Science Engineering at Aditya College of Engineering & Technology. My interests lie in building web technologies and products, as well as exploring AI/ML, data-driven solutions, and innovative applications in AR/VR and multimodal AI.
        </p>
        ...
        <div className="text-center pt-8">
          <button className="bg-indigo-500 px-3 py-1 font-semibold text-white inline-flex items-center space-x-2 rounded dark:bg-indigo-600">
            ...
            <a
              ...
              target="_blank"
              href="https://saireddya-1.github.io/"
            >
              See My Works
            </a>
          </button>
